...
namespace Rankin.Views
{
    public partial class AddElector : Form
    {
        ...
        private void SaveElector_Click(object sender, EventArgs e)
        {
            ...
            string MatElect = nom.Substring(0, nom.Length - 1);
            string partent = "IUC2022";
            string matFin = $"{partent}{MatElect}";
           matriculetxt.Text = matFin;
        ...
        {
            string nom = nomTxt.Text;
            string MatElect = nom.Substring(0,2 );
            string partent = "IUC2022";
            string matFin = $"{partent}{MatElect}";
            matriculetxt.Text = matFin;
        }
