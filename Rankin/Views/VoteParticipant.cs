          ...
          if(voted == 0)
            {
                try
                {
                    ...
                    UpdateVoteuser();
                    con.Close();
                    MessageBox.Show("vous avez voter pour ce participant  avec succes\n", "vote", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    voted = voted + 1;
                    pagedevote.Close();
            ...
            {
                MessageBox.Show("vous avez deja voté pour ce participant veillez vous deconnecter !!", "error",MessageBoxButtons.OK, MessageBoxIcon.Error) ;
            }
